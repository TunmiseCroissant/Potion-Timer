...
class theme {
    constructor(name, light, bright, dark, back) {
        this.name = name,
        this.light = light,
        this.bright = bright,
        this.dark = dark
...
const PresetThemes = {
    Purple : new theme("Purple", "#c6aff4", "#2f175d", "#1c0c39", "#BAB6FF"),
...
let currentTheme = PresetThemes.Purple;

const addTheme = (div, theme) => {
...
const updateTheme = (theme) => {
    ...
    spline.setBackgroundColor(theme.back)
}
...
const createTheme = (colors) => {
    ...
    addTheme(document.getElementById("CustomThemes"), newTheme)
}
